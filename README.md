Для начала работы необходимо склонировать данный репозиторий в рабочую папку и выполнить в консоли следующие команды:

  

для разворота проекта:
...
исходники содержатся в директории **js/**
